...
void loop() {
  ...
  /*
    ...
    */
   /* if(SS2_LEFT_IN==0&&SS4_RIGHT_IN==1)
    {
       delay(5);  
      Left(100);
      delay(5);
    ...
    else if(SS2_LEFT_IN==1&&SS4_RIGHT_IN==0)
    {
     delay(5);
      Right(100);
      delay(5);
    ...
    else if(SS2_LEFT_IN==1&&SS4_RIGHT_IN==1)
    {
      Forward(150);
    }
    */
  ...
  //{ 
    ...
    //if(Data == 'M'){
     ...
     if(digitalRead(SS2_LEFT_IN) == 0  && digitalRead(SS4_RIGHT_IN) == 1){
       //Backward();
       //delay(5);
     ...
     //else if(digitalRead(SS1_LEFT_OUT) == 0 && digitalRead(SS5_RIGHT_OUT) == 1){
       ...
       //delay(5);
     //}
     //else if(digitalRead(SS2_LEFT_IN) == 1 && digitalRead(SS4_RIGHT_IN) == 1 && digitalRead(SS4_RIGHT_IN) == 1 && digitalRead(SS4_RIGHT_IN) == 1 && digitalRead(SS4_RIGHT_IN) == 1 ){
       //Backward(100);
